...
<head>
  ...
  <title>MIDTERM_RESTFULWEB</title>
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <nav class="navbar" data-navbar>
        ...
        <div class="wrapper">
          <a href="#" class="logo">
            <img src="./assets/images/logo.png" width="162" height="50" alt="">
          </a>
      ...
      <section class="section hero has-bg-image" id="home" aria-label="home"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            A journey of a thousand miles begins with a <span class="span">single</span> step
            </h1>
          </div>
